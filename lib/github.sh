...
#source: https://raw.githubusercontent.com/ethereum/solc-bin/ca4220fe82781412056877db150e6eba86eee5f0/download-release.sh
#author: @cameel
#edits: adjusted bashism's and minor edits
#v2021.04.01
...
#shellcheck  disable=SC1091 source=~/.asdf/solidity/config.sh
#. "$(locate_config)"
